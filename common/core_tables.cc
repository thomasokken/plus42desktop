...
const command_spec cmd_array[] =
{
    ...
    { /* DIV */        docmd_div,         "\000",                0x00, 0x00, 0x00, 0x43,  1, ARG_NONE,   2, 0x8f },
    { /* MUL */        docmd_mul,         "\001",                0x00, 0x00, 0x00, 0x42,  1, ARG_NONE,   2, 0x8f },
    ...
    { /* 10_POW_X */   docmd_10_pow_x,    "10\036X",             0x00, 0x00, 0x00, 0x57,  4, ARG_NONE,   1, 0x0f },
    { /* LN */         docmd_ln,          "LN",                  0x00, 0x00, 0x00, 0x50,  2, ARG_NONE,   1, 0x0f },
    { /* E_POW_X */    docmd_e_pow_x,     "E\036X",              0x00, 0x00, 0x00, 0x55,  3, ARG_NONE,   1, 0x0f },
    { /* SQRT */       docmd_sqrt,        "SQRT",                0x00, 0x00, 0x00, 0x52,  4, ARG_NONE,   1, 0x8f },
    { /* SQUARE */     docmd_square,      "X\0362",              0x00, 0x00, 0x00, 0x51,  3, ARG_NONE,   1, 0x8f },
    { /* INV */        docmd_inv,         "1/X",                 0x00, 0x00, 0x00, 0x60,  3, ARG_NONE,   1, 0x8f },
    { /* Y_POW_X */    docmd_y_pow_x,     "Y\036X",              0x00, 0x00, 0x00, 0x53,  3, ARG_NONE,   2, FUNC },
    ...
    { /* STO_DIV */    docmd_sto_div,     "STO\000",             0x00, 0x85, 0x00, 0x95,  4, ARG_VAR,    1, 0x8f },
    { /* STO_MUL */    docmd_sto_mul,     "STO\001",             0x00, 0x84, 0x00, 0x94,  4, ARG_VAR,    1, 0x8f },
    ...
    { /* RCL_DIV */    docmd_rcl_div,     "RCL\000",             0x00, 0x95, 0xf2, 0xd4,  4, ARG_VAR,    1, 0x8f },
    { /* RCL_MUL */    docmd_rcl_mul,     "RCL\001",             0x00, 0x94, 0xf2, 0xd3,  4, ARG_VAR,    1, 0x8f },
    ...
    { /* X_LE_Y */     docmd_x_le_y,      "X\011Y?",             0x00, 0x00, 0x00, 0x46,  4, ARG_NONE,   2, 0x81 },
    { /* X_GE_Y */     docmd_x_ge_y,      "X\013Y?",             0x00, 0x00, 0xa2, 0x60,  4, ARG_NONE,   2, 0x81 },
    ...
    { /* RUP */        docmd_rup,         "R\036",               0x00, 0x00, 0x00, 0x74,  2, ARG_NONE,   0, NA_T },
    ...
    { /* E_POW_X_1 */  docmd_e_pow_x_1,   "E\036X-\261",         0x00, 0x00, 0x00, 0x58,  5, ARG_NONE,   1, 0x05 },
    ...
    { /* UP */         docmd_up,          "\036",                0x00, 0x00, 0xa6, 0xde,  1, ARG_NONE,   0, FUNC },
    ...
    { /* SST_UP */     NULL,              "SST\036",             0x40, 0x00, 0x00, 0x00,  4, ARG_NONE,   0, NA_T },
    ...
    { /* RUPN */       docmd_rupn,        "R\036N",              0x00, 0xf7, 0xf2, 0xa6,  3, ARG_NUM9,   0, NA_T },
    ...
    { /* PRRG */       docmd_prrg,        "PRRG",                0x00, 0x00, 0xa7, 0x50,  4, ARG_NONE,   0, NA_T },
    ...
    { /* X_LE_NN */    docmd_x_le_nn,     "X\011?",              0x00, 0x20, 0xf2, 0x18,  3, ARG_VAR,    1, 0x81 },
    { /* X_GE_NN */    docmd_x_ge_nn,     "X\013?",              0x00, 0x21, 0xf2, 0x19,  3, ARG_VAR,    1, 0x81 },
    ...
    { /* GEN_LE */     docmd_gen_le,      "\011",                0x00, 0x00, 0xa7, 0xad,  1, ARG_NONE,   2, 0x81 },
    { /* GEN_GE */     docmd_gen_ge,      "\013",                0x00, 0x00, 0xa7, 0xae,  1, ARG_NONE,   2, 0x81 },
    ...
    { /* TO_UNIT */    docmd_to_unit,     "\017UNI\324",         0x00, 0x00, 0xa6, 0xf5,  5, ARG_NONE,   2, 0x91 },
    { /* FROM_UNIT */  docmd_from_unit,   "UNI\324\017",         0x00, 0x00, 0xa6, 0xf6,  5, ARG_NONE,   1, 0x81 },
