...
static int ext_misc_cat[] = {
    ...
    CMD_GETMI,  CMD_LINE,    CMD_LOCK,     CMD_PCOMPLX,     CMD_PLOT_M, CMD_PRREG,
    CMD_PUTLI,  CMD_PUTMI,   CMD_RCOMPLX,  CMD_SPFV,        CMD_SPPV,   CMD_STRACE,
    CMD_TVM,    CMD_UNLOCK,  CMD_USFV,     CMD_USPV,        CMD_X2LINE, CMD_ACCEL,
...
static int ext_misc_cat[] = {
    ...
    CMD_GETMI,  CMD_LINE,    CMD_LOCK,     CMD_PCOMPLX,     CMD_PLOT_M, CMD_PRREG,
    CMD_PUTLI,  CMD_PUTMI,   CMD_RCOMPLX,  CMD_SPFV,        CMD_SPPV,   CMD_STRACE,
    CMD_TVM,    CMD_UNLOCK,  CMD_USFV,     CMD_USPV,        CMD_X2LINE, CMD_FPTEST
};
...
static int ext_misc_cat[] = {
    ...
    CMD_GETMI,  CMD_LINE,    CMD_LOCK,     CMD_PCOMPLX,     CMD_PLOT_M, CMD_PRREG,
    CMD_PUTLI,  CMD_PUTMI,   CMD_RCOMPLX,  CMD_SPFV,        CMD_SPPV,   CMD_STRACE,
    CMD_TVM,    CMD_UNLOCK,  CMD_USFV,     CMD_USPV,        CMD_X2LINE, CMD_NULL
};
#define MISC_CAT_ROWS 4
#endif
#endif
