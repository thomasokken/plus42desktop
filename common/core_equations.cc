...
static short catalog[] = {
    ...
    CMD_SLOPE,     CMD_SPFV,      CMD_SPPV,    CMD_SQRT,     EQCMD_STACK,    CMD_STOP,
    CMD_STR_T,     CMD_TAN,       CMD_TANH,    CMD_TIME,     CMD_TRANS,      EQCMD_TRN,
    CMD_TYPE_T,    EQCMD_NUM_T,   CMD_UNIT_T,  CMD_USFV,     CMD_USPV,       CMD_UVEC,
