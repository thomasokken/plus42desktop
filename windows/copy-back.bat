...
copy core_commands9.cpp ..\common\core_commands9.cc
copy core_commands9.h ..\common
copy core_commandsa.cpp ..\common\core_commandsa.cc
copy core_commandsa.h ..\common
copy core_display.cpp ..\common\core_display.cc
copy core_display.h ..\common
copy core_equations.cpp ..\common\core_equations.cc
copy core_equations.h ..\common
