...
storing them in the directory where Plus42Decimal.exe or Plus42Binary.exe are
...
The keyboard map is %APPDATA%\Plus42\keymap.txt, which is usually
C:\Users\<YourUserName>\AppData\Roaming\Plus42\keymap.txt. You can edit this
...
and restart Plus42 for the changes to take effect.
